...
public class Desconto {
	public static void main(String[] args) {
		...
		if ((sexo != 1) && (sexo != 2)) {
			...
			if (sexo == 1) {
				System.out.println("Parabéns " + nome + " o valor de sua compra saírá " + String.format("%.2f", valor)
						+ " com desconto de 13% que será " + String.format("%.2f", totalF));
			} else {
				System.out.println("Parabéns " + nome + " o valor de sua compra é de R$ " + String.format("%.2f", valor)
						+ " com desconto de 5% será R$ " + String.format("%.2f", totalM));
				leia.close();
			}
		}
	}
